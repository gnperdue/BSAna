...
// Wed Nov 20 10:32:52 2013 by ROOT version 5.34/08
// from TTree gst/GENIE Summary Event Tree
// found on file: gntp.berger_sehgal.gst.root
//////////////////////////////////////////////////////////
...
class gstana {
	public :
		...
		virtual void     Loop(unsigned int svn_tag);
...
gstana::gstana(TTree *tree) : fChain(0) 
{
	...
	if (tree == 0) {
		TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gntp.berger_sehgal.gst.root");
		if (!f || !f->IsOpen()) {
			f = new TFile("gntp.berger_sehgal.gst.root");
		}
